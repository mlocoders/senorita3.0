...
@register(pattern="^/t(elegraphmedia|elegraphtext) ?(.*)")
async def _(event):
    if event.fwd_from:
        return
...
__help__ = """
 - /telegraphmedia : Get Telegraph Link Of Replied Media
 - /telegraphtext: Get Telegraph Link of Replied Text
"""
