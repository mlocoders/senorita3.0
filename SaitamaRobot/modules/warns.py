...
import telegram
from SaitamaRobot import BAN_STICKER, TIGERS, WOLVES, dispatcher, REDIS
...
WARN_HANDLER = CommandHandler("warn", warn_user, filters=Filters.chat_type.groups, run_async=True)
